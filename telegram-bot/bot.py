        ...
        if files:
            for ch in YOUR_CHANNELS:
                await client.send_file(
                    ch,
                    files,
                    caption=modified_caption or None,
                    formatting_entities=modified_entities or None
                )

            print(f'✅ Album cloned ({len(files)} photos)')
